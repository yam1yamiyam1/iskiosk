    ...
    <div class="container-xl">
        ...
        <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href="{{ url('/') }}">
                ...
                <img 
                    src="{{ asset('assets/logo/PUPLogo.svg') }}" 
                    width="110" 
                    height="32" 
                    alt="PUP Logo"
            ...
            <div class="nav-item dropdown">
                <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                    <span class="avatar avatar-sm shadow-none"
                        style="background-image: url('{{ Auth()->user()->image == '' ? asset('storage/users/p1.png') : asset('storage/users/' . Auth()->user()->image) }}')">
                    </span>
                ...
                <div class="dropdown-menu profile-dropdown-menu">
                    ...
                    <a href="{{ route('test.route') }}" class="dropdown-item">
