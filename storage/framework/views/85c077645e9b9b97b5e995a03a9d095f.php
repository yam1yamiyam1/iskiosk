        ...
        <div class="navbar">
            <div class="container-xl">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item <?php echo e(request()->is('records*') ? 'active' : ''); ?>">
                        <a class="nav-link" href="<?php echo e(route('records.index')); ?>">
                            <span class="nav-link-icon d-md-none d-lg-inline-block">
                                <i class="fa-solid fa-folder-open"
                                style="color: <?php echo e(request()->is('records*') ? '#ff0d0b' : '#720100'); ?>;">
                                </i>
                            </span>
                            <span class="nav-link-title">
...
<?php /**PATH C:\laragon\www\iskiosk\resources\views/layouts/body/navbar.blade.php ENDPATH**/ ?>