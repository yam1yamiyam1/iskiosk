...
<?php if (! $__env->hasRenderedOnce('91a3e777-6177-487a-8fc7-0a793bc3d25e')): $__env->markAsRenderedOnce('91a3e777-6177-487a-8fc7-0a793bc3d25e');
...
<script>
    ...
    async function handleTrackingScan(code) {
        console.log("🔍 Checking tracking code:", code);
        ...
        try {
            ...
            if (data.status === 'no_change') {
                showScanModal(
                    'No Change',
                    `ℹ️ Current status:<br><b>${data.current_status}</b>`,
                    'warning'
                );
            }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.tabler', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\kiosk\resources\views\admin\document.blade.php ENDPATH**/ ?>