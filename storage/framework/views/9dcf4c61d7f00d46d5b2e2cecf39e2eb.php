...
<nav class="nav-top">
<img src="<?php echo e(asset('assets/img/side_header3.png')); ?>" alt="side_header" class="side">
</nav>
<div class="form-container">
  ...
  <form id="submitForm" action="<?php echo e(route('kiosk.store')); ?>" method="POST" novalidate>
    ...
    <div class="col-4">
      ...
      <input type="text" id="given_name" name="given_name" placeholder="Enter your Given Name" required>
    </div>
        ...
        try {
          ...
          if (data.status === 'success') {
            ...
            showStatusModal(
              ...
              "Please insert your document into the drawer.",
              "success"
            );
                ...
                try {
                  ...
                  if (respData.status === 'success') {
                    ...
                    statusBtn.onclick = () => {
                      ...
                      ws.send(JSON.stringify({ command: `CLOSE_${drawerToOpen}` }));
                    };
...
<?php echo $__env->make('layouts.kiosk', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\kiosk\resources\views\kiosk\submit.blade.php ENDPATH**/ ?>